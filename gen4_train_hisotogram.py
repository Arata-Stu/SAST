...
for dt in event_frame_dts:
    command = f"""
    python3 RVT/train.py model=rnndet dataset=gen4 dataset.path={data_dir} wandb.project_name=RVT_gen4_histo_{dt} \
    wandb.group_name=1mpx +experiment/gen1={mdl_cfg}.yaml hardware.gpus={gpu_ids} \
